...
const Repository = "https://github.com/86669666/cpamp-maintained"
const IndexURL = "https://raw.githubusercontent.com/86669666/cpamp-maintained/update-channel/update-index.json"
...
func safeLink(raw string) bool {
	u, err := url.Parse(raw)
	return err == nil && u.Scheme == "https" && u.Host == "github.com" && u.User == nil && !strings.Contains(u.Path, `\`) && strings.HasPrefix(path.Clean(u.Path), "/86669666/cpamp-maintained/")
}
func (info ReleaseInfo) Validate(tag string) error {
	...
	if info.Distribution.Docker != nil {
