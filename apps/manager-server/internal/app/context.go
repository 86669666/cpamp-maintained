...
func fromExisting(
	...
	updateCheckEnabled := os.Getenv("CPAMP_UPDATE_CHECK_ENABLED") == "true"
	return &Context{
		UpdateCheckService:   updatechecksvc.New(st, buildinfo.Version, buildinfo.SourceCommit, updateCheckEnabled),
		Config:               cfg,
		Store:                st,
