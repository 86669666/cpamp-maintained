...
const release = (version = 'v1.12.11'): ReleaseInfo => ({
  ...
  update: {
    ...
    upgrade_guide_url:
      'https://github.com/86669666/cpamp-maintained/blob/' + version + '/docs/update-check.md',
  },
  distribution: {
    docker: null,
...
describe('ManagerUpdatePage', () => {
  it('keeps instructions collapsed until requested and exposes the maintained native release', async () => {
    await renderPage();
    ...
    expect(download.props.href).toBe(
      'https://github.com/86669666/cpamp-maintained/releases/tag/v1.12.11'
    );
