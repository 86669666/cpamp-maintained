...
function ReleaseDetails({
  ...
  const supportsDocker = info.distribution.docker !== null;
  const [deployment, setDeployment] = useState<'docker' | 'native'>(
    supportsDocker ? 'docker' : 'native'
  );
  ...
  const image = supportsDocker
    ? info.distribution.docker!.image + ':' + info.distribution.docker!.version_tag
    : '';
        ...
        >
          ...
          <div role="tabpanel" aria-labelledby={'manager-deployment-' + deployment}>
            <ol className={styles.instructions}>
              ...
              <li>
                {t(
                  supportsDocker && deployment === 'docker'
