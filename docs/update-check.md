...
<!-- cpamp-update
{
  ...
  "update": {
    ...
    "upgrade_guide_url": "https://github.com/86669666/cpamp-maintained/releases/tag/v2.0.0"
  },
...
固定地址：`https://raw.githubusercontent.com/86669666/cpamp-maintained/update-channel/update-index.json`。
