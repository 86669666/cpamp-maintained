...
for arg in "$@"; do
  case "$arg" in
    https://raw.githubusercontent.com/86669666/cpamp-maintained/update-channel/stable-version.txt)
      printf 'v1.2.3'
      exit 0
      ;;
    */health) exit 0 ;;
...
set -euo pipefail
for arg in "$@"; do
  if [ "$arg" = "https://raw.githubusercontent.com/86669666/cpamp-maintained/update-channel/stable-version.txt" ]; then
    printf 'v1.2.3'
    exit 0
  fi
done
